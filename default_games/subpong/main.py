...
background("data/sea.png")

edge = Actor("data/edge.png")
edge.goto(width / 2, height / 2)

playerL = Actor("data/fish2.png")
playerL.goto(50, 50)

playerR = Actor("data/fish1.png")
...
ball = Actor("data/seastar1.png")
ball.scale(0.4)

music = Sound("data/littlesong.wav")
# music.setvolume(50)
